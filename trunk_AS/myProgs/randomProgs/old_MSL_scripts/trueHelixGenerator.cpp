...
string programDescription = "This program is derived from generateBaselinevdW to just output a helix of a selected sequence";
...
int main(int argc, char *argv[]){
	...
	**********************************************************************************/
	...
	//since I'm assigning to glyAPV (two chains) the energies might be doubled, but this isn't something I've checked yet
