...
string programName = "baselineSelfPairComparison_02";
string programDescription = "This program is a version of baselineSelfPairComparison_01 that takes into account leucines at the edges of the sequence.";
string programAuthor = "Gilbert Loiseau";
string programVersion = "4";
string programDate = "8 October 2020";
