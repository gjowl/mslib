...
string programDescription = "This program is a variant of generateRandomSequence that designs randomized sequences to evaluate baselines energies against monomer sequences; removed many extra functions leftover from CATM";
	...
	**********************************************************************************/
	...
	while (seqAccept < seqNumber){
		...
		if (opt.weight_vdw == 1 && opt.weight_hbond == 1){
			...
			for (uint i=0; i < opt.baselinesvdw.size(); i++){
