...
string programDescription = "Designs sequences for backbone geometries extracted from the PDB; this version has multithreading on BBOptimization for the specified number of sequences";
