...
int main(int argc, char *argv[]){
    ...
    vector<int> clashPositions = OP.getIntVector("clashPositions"); // interface positions
	...
	// Set weights
	Eset->setWeight("CHARMM_VDW", weight_vdw);
	Eset->setWeight("SCWRL4_HBOND", weight_hbond);
	Eset->setWeight("CHARMM_IMM1REF", weight_solv);
	Eset->setWeight("CHARMM_IMM1", weight_solv);
    ...
    deleteTerminalBondInteractions(_sys,deleteTerminalInteractions);
