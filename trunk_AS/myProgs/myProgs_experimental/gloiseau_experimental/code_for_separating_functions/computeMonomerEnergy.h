...
// string programName = "computeMonomerEnergy";
// string programDescription = "Computes the monomer energy for a given sequence";
// string programAuthor = "Gilbert Loiseau";
// string programVersion = "1";
// string programDate = "20 March 2023";
...
void computeMonomerEnergy(System &_sys, Options &_opt, map<string,map<string,double>> &_sequenceEnergyMap, string _seq, ofstream &_sout, auto _startTime) {
	// output the start time
	outputTime(_startTime, "Compute Monomer Energy Start", _sout);
	...
	// output end time
	outputTime(_startTime, "Compute Monomer Energy End", _sout);
}
...
void computeMonomerEnergy(System &_sys, System &_helicalAxis, Options &_opt, Transforms & _trans, map<string,map<string,double>> &_sequenceEnergyMap, string _seq,
 RandomNumberGenerator &_RNG, ofstream &_sout, auto _startTime) {
	// output the start time
	outputTime(_startTime, "Compute Monomer Energy Start", _sout);
...
void computeMonomerEnergy(System &_sys, System &_helicalAxis, Options &_opt, Transforms & _trans, map<string,map<string,double>> &_sequenceEnergyMap, string _seq,
 RandomNumberGenerator &_RNG, ofstream &_sout, ofstream &_err, auto _startTime) {
	// output the start time
	outputTime(_startTime, "Compute Monomer Energy Start", _sout);
