...
class SelfPairManager {
	public:
		...
		std::vector<vector<unsigned int>> getBestSCMFBiasedMCStates();
	...
	private:
		...
		std::vector<vector<unsigned int>> bestSCMFBiasedMCstates;
		...
		//void threadGetEnergy()(Interaction &l, double &E);
		static void threadGetEnergy(Interaction* l, double &E) ;
		//static void threadGetEnergy(double *E) ;
		//static void threadGetEnergy(Interaction** l) ;

};

inline void SelfPairManager::threadGetEnergy(Interaction* l, double &E){
	E += l->getEnergy();
}
//inline void SelfPairManager::threadGetEnergy(double *E){
	//E += 1;
//}
//The below was the first I got to work with Interaction
//inline void SelfPairManager::threadGetEnergy(Interaction** l){
//	cout << (*l)->getEnergy();
//	//l->getEnergy();
//}
