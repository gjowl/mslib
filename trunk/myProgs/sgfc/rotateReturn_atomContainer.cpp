...
int main () {
	...
	AtomContainer pdbOriginal;
	AtomContainer pdbTransform;
	Transforms tr;
	...
	pdbTransform.writePdb("myProgs/1C3W-trans-container.pdb"); 
	...
	if (tr.rmsdAlignment(pTransform, pOriginal)) {
		...
		pdbTransform.writePdb("myProgs/1C3W-align-container.pdb");
	}
